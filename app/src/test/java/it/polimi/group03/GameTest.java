...
//        Player player = createPlayer(0,"tatibloom");
//        player.addBead(createBead("black",0,0));
//        player.addBead(createBead("black",0,0));
//        player.addBead(createBead("black",0,0));
//        player.addBead(createBead("black",0,0));
//        players.add(player);
...
//    }
//
//    private Player createPlayer(int id, String nickname) {
...
//    }
//
//    private Bead createBead(String color, int posX, int posY) {
//        Bead bead = new Bead();
//        bead.setColor(color);
//        bead.setActive(true);
